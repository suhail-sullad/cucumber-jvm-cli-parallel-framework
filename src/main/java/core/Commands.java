...
import core.handlers.LocatorHandler;
...
public class Commands {
    ...
    public core.commands.Windows window() {
    ...
    public core.commands.JavaScript javascript() {
    ...
    public core.commands.Element element() {
    ...
    public core.commands.Utility utility() {
    ...
    public core.commands.Wait waiting() {
        return new EbselenWait(defaultTimeout);
    }


    public core.commands.Wait waitFor(int timeout) {
