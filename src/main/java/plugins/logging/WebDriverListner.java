...
public class WebDriverListner extends AbstractWebDriverEventListener {
	...
	public WebDriverListner(String scenarioname) throws IOException {
		...
		WebDriverListner.filename = "./target/logs/" + scenarioname + ".html";
	 ...
	 * 
	 * //testlogger.info(
	 * "\n<div><b>Performing click on Element:</b> <font color=\"#0000FF\">"
	 * +getcomplexelement(element)+"</font></div> </b>On page : <b>" +
	 * driver.getTitle()); }
	 * 
	 ...
	 * 
	 * //testlogger.info(
	 * "\n<b>Successfull click  Element:</b> <font color=\"#006600\">"
	 * +getcomplexelement(element)+"</font></div> </b>On page : </b>" +
	 * driver.getTitle()); }
	 */
	 ...
	 * 
	 * Pattern p= Pattern.compile("->.*]"); Matcher elementinfo =
	 * p.matcher(element.toString()); StringBuffer sb =new StringBuffer();
	 * while(elementinfo.find()) sb.append(elementinfo.group()); return
	 * sb.toString(); }
	 */
