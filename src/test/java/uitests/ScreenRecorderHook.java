...
public class ScreenRecorderHook{
	...
	public void close(Scenario scenario) throws IOException,
		...
		if(videoreporting.equalsIgnoreCase("ENABLED"))
		scenario.write("<br/><a href=\"" + record.stoprecording()+ "\">Click here to navigate to video</a>");
		this.fd.quit();
		if(loggingstatus.equalsIgnoreCase("ENABLED"))
		{
			...
			listner.quitlogger();
			scenario.write("<br/><a href=\"../logs/" +scenario.getName()+ ".html\">Click for log information.</a>");
		}
